...
const allMockProducts = [
    ...
    { id: 104, category: "Anillos", name: "Anillo Coral", price: 850.00, image: "img/catalogo/anillos/anillo4.jpg", description: "Anillo coral con autenticaciones de mar" },
    ...
    { id: 203, category: "Pendientes", name: "Aretes Glamurosos", price: 700.00, image: "img/catalogo/aretes/aretes1.jpg", description: "Pendientes largos glamurosos, perfectos para noches de fiesta." },
    { id: 204, category: "Pendientes", name: "Aretes Ojos de tortuga", price: 450.00, image: "img/catalogo/aretes/aretes2.jpg", description: "Aretes pequeños ojos de tortuga para un toque pequeño pero detalloso." },
    { id: 205, category: "Pendientes", name: "Pendientes watch ear", price: 750.00, image: "img/catalogo/aretes/aretes4.jpg", description: "Aretes largos con un toque elegante y tecnológico." },
    { id: 301, category: "Collares", name: "Collar Corazón Zafiro", price: 890.00, image: "img/catalogo/collares/collarz.jpg", description: "Delicado collar con dije de corazón y zafiro." },
    { id: 302, category: "Collares", name: "Gargantilla Oro Blanco", price: 1100.00, image: "img/catalogo/collares/collarob.jpg", description: "Sofisticada gargantilla en oro blanco de 18k." },
    { id: 303, category: "Collares", name: "Collar Oso", price: 800.00, image: "img/catalogo/collares/collar1.jpg", description: "Collar con un toque tierno y sofisticado" },
    { id: 304, category: "Collares", name: "Collar corazón", price: 900.00, image: "img/catalogo/collares/collar2.jpg", description: "Hermoso collar , especial para destacar amor" },
    { id: 401, category: "Pulseras", name: "Pulsera Infinito Plata", price: 250.00, image: "img/catalogo/pulseras/pulserai.jpg", description: "Pulsera de plata con símbolo de infinito." },
    { id: 403, category: "Pulseras", name: "Brazalete de oro Estrella", price: 400.00, image: "img/catalogo/pulseras/pulsera2.jpg", description: "Brazalete de oro con un estilo rockstar." },
    { id: 402, category: "Pulseras", name: "Brazalete Rígido Dorado", price: 480.00, image: "img/catalogo/pulseras/pulserad.jpg", description: "Imponente brazalete rígido bañado en oro." },
    { id: 404, category: "Pulseras", name: "Brazalete Corazones dorados", price: 480.00, image: "img/catalogo/pulseras/pulsera3.jpg", description: "Destaca tu toque femenino y poderoso." },
];
let cart = [];
